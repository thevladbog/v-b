...
- Classification: **READ-ONLY**
- Expected output: bounded local parsing reports four exact DRAFT legal identities, both direct contact links on both preserved landings, and an ordered six-entry `responses` array containing only file names and SHA-256 hashes
