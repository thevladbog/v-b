...
export const SITE_CONTENT: Readonly<Record<Locale, SiteContent>> = {
  ru: {
    ...
    contact: { eyebrow: "контакт / новый проект", title: "Расскажите, что должно начать работать лучше", lead: "Подойдёт короткое описание продукта, процесса или текущего сбоя. На первом разговоре разберём задачу и поймём, есть ли хороший рабочий формат.", telegram: "Telegram", email: "Email", formName: "Имя", formContact: "Email или Telegram", formMessage: "Что вы хотите спроектировать или улучшить?", formSubmit: "Подготовить обращение", formNote: "Мокап: данные никуда не отправляются.", formSuccess: "Сценарий работает. В production-версии обращение будет отправлено безопасным способом." },
  ...
  en: {
    ...
    contact: { eyebrow: "contact / new project", title: "Tell me what needs to work better", lead: "A short description of the product, process, or current failure is enough. The first conversation is for understanding the problem and whether there is a strong working fit.", telegram: "Telegram", email: "Email", formName: "Name", formContact: "Email or Telegram", formMessage: "What do you want to design or improve?", formSubmit: "Prepare enquiry", formNote: "Mockup: no data is transmitted.", formSuccess: "The interaction works. In production, the enquiry will be transmitted securely." },
