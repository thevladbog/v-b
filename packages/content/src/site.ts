...
export const SITE_CONTENT: Readonly<Record<Locale, SiteContent>> = {
  ru: {
    ...
    contact: {
      ...
      formSuccess: "Черновик заполнен корректно.",
      ...
      errors: {
        ...
        consent: "Для отправки потребуется явно подтвердить согласие.",
      },
    },
  ...
  en: {
    ...
    contact: {
      ...
      formSuccess: "The enquiry draft is valid.",
      ...
      errors: {
        ...
        consent: "Submission will require explicit consent confirmation.",
      },
    },
